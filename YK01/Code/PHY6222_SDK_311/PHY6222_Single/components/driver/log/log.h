...
#define PRINT_LEVEL			LV_ALL
#if(DEBUG_INFO == 1)
	#if(PRINT_LEVEL == LV_NO)
		#define	LOG(...)					//dbg_printf(__VA_ARGS__)
		#define AT_LOG(...)					//dbg_printf(__VA_ARGS__)
		#define MY_LOG(...)  				//dbg_printf(__VA_ARGS__)
		#define PRINT_INFO(...)				//dbg_printf(__VA_ARGS__)
		#define PRINT_DEBUG(...)			//dbg_printf(__VA_ARGS__)
	#endif
	#if(PRINT_LEVEL == LV_INFO)
		#define	LOG(...)					dbg_printf(__VA_ARGS__)
		#define AT_LOG(...)					dbg_printf(__VA_ARGS__)
		#define MY_LOG(...)  				dbg_printf(__VA_ARGS__)
		#define PRINT_INFO(...)				//dbg_printf(__VA_ARGS__)
