...
const pTaskEventHandlerFn tasksArr[] =
{
	...
	UserBase1_ProcessEvent,
	UserBase2_ProcessEvent,
	UserBase3_ProcessEvent,
	UserBase4_ProcessEvent,
};
...
void osalInitTasks( void )
{
	...
	UserBase1_Init(taskID++);
	
	UserBase2_Init(taskID++);
	
	UserBase3_Init(taskID++);
	
	UserBase4_Init(taskID);
}
#endif
/*********************************************************************
*********************************************************************/
